...
public class ProdutosDAO {
    ...
    /**
     * Retorna uma lista com todos os produtos cujo status é "Vendido".
     *
     * @return um ArrayList de ProdutosDTO contendo apenas os produtos vendidos.
     */
    public ArrayList<ProdutosDTO> listarProdutosVendidos() {
        // Cria uma nova lista para armazenar os produtos vendidos
        ArrayList<ProdutosDTO> listagemVendidos = new ArrayList<>();

        // 1. Comando SQL para selecionar os dados, filtrando por status
        String sql = "SELECT * FROM produtos WHERE status = ?";

        try {
            prep = conn.prepareStatement(sql);

            // Define o valor do primeiro '?' na query SQL para "Vendido"
            ...
            while (resultset.next()) {
                ...
                // Adiciona o objeto preenchido na lista de vendidos
